...
class SudokuGenerator:
    ...
    def remove_cells(self, removed_cells):
        cells_removed = 0
        while cells_removed < removed_cells:
...
def generate_sudoku(size, removed):
    ...
    full_board = sudoku.generate_full_board()
    sudoku.remove_cells(removed)
    return full_board, sudoku.get_board()